...
import PanelAuditSection from './components/PanelAuditSection';
import { AppSection, ImpedanciaType, Manufacturer, Project, RCDDevice, ImpedanciaState } from './types';
...
const INITIAL_IMPEDANCIA: ImpedanciaState = { devices: [{ id: '1', name: 'PIA 1', lineValue: '', bucleValue: '', lineCurve: 'C', lineAmps: '16', manufacturer: Manufacturer.GENERIC }], bucleRa: '', bucleVc: '', isHumid: false };
...
const App: React.FC = () => {
  ...
  const menuItems = [
    ...
    { id: AppSection.AUDIT_PANEL, label: 'Auditoría Vision IA', desc: 'Análisis Visual de Cuadros', icon: <ScanEye size={28} />, class: 'vibrant-glass-cyan' },
    { id: AppSection.CALCULATOR, label: 'Cálculo de Tubo', desc: 'Diámetro según REBT', icon: <Ruler size={28} />, class: 'vibrant-glass-amber' },
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case AppSection.AUDIT_PANEL: return <PanelAuditSection />;
